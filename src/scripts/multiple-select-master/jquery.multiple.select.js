...
(function($) {
    ...
    function MultipleSelect($el, options) {
        ...
        //DON'T USE THE PARENT ELEMENT TO SET THE WIDTH OF THE DROP.  SET MINWIDTH INSTEAD
        /*this.$drop.css({
        ...
        /*this.$drop.css({
            min-width: (options.width || elWidth) + 'px'
        });*/
    ...
    MultipleSelect.prototype = {
        ...
        optionToHtml: function(i, elm, group, groupDisabled) {
            ...
            if ($elm.is('option') && (group != undefined)) {
                var value = $elm.val(),
                    text = $elm.text(),
                    title = $elm.text(),
               ...
               /* if(text.length > 18 ){
                ...
                html.push(
                    '<li' + (multiple ? ' class="multiple"' : '') + '>',
                        '<label ' + (disabled ? ' class="disabled groupoption"' : 'class="groupoption"') + 'title="' + title + '" >',
                            '<input type="' + type + '" name="selectItem" title="' + title + '" value="' + value + '"' +
